...
const TrustedBy: React.FC = () => (
  <section className={`bg-white min-h-screen flex flex-col justify-center gap-16 md:gap-32 ${s.bg}`}>
    ...
    <div className='flex flex-col justify-center items-center'>
      <h3 className='text-xl mb-19 font-bold text-center'>
    ...
    <div className='flex flex-col justify-center items-center'>
      <div className='container mx-auto lg:max-w-[70%] lg:px-10'>
        <h3 className='text-3xl lg:text-4xl text-center px-10 !leading-[3.5rem]'>We believe in good communcation and a fully transparent development process.</h3>
      </div>
    </div>
    <Testimonials />
